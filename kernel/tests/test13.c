...
int test13(void *arg)
{
        ...
        pid1 = start(psender_msg, 4000, 131, "psender", (void*)1);
        pid2 = start(psender_msg, 4000, 130, "psender", (void*)2);
        pid3 = start(psender_msg, 4000, 129, "psender", (void*)3);
        for (i=0; i<2; i++) {
        ...
        pid1 = start(preceiver_msg, 4000, 131, "preceiver", (void*)1);
        pid2 = start(preceiver_msg, 4000, 130, "preceiver", (void*)2);
        pid3 = start(preceiver_msg, 4000, 129, "preceiver", (void*)3);
        for (i='a'; i<='b'; i++) {
